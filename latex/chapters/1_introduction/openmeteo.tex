...
Open-Meteo is an open-source weather data platform and community-driven weather forecasting project\cite{openmeteo}. Open-Meteo aims to provide access to weather data and forecasts that are openly accessible to the public and can be used for a variety of applications, including research, development, and personal use.
