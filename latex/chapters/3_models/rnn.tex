...
\begin{algorithm}[H]
	...
	\begin{algorithmic}
		...
		\For{\textbf{each} (batch\_id, vbefore, vafter, vfuture, vtarget) \textbf{in} validation.next\_batch()}
		\State val\_prediction $\gets$ model(vbefore, vafter, vfuture) \Comment{Model inference}
