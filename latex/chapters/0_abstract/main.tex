\begin{abstract}
	...
	learning techniques. In particular, a deep learning model based on Fully Connected
	Neural Networks (FCNN) and Recurrent Neural Networks (RNN) are proposed to capture
