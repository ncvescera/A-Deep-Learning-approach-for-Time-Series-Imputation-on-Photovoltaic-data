\section{Origianl Dataset} \label{sec:dataset}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}[c]{l|l|l|l|l|l}
			...
			\multicolumn{1}{c|}{\makecell{\textbf{TotalEnergy} \\\textbf{(kWh)}}} &
			\multicolumn{1}{c|}{\makecell{\textbf{Frequency}   \\\textbf{(Hz)}}}    &
...
\begin{figure}[H]
	...
	%Nell'immagine sono riportati i plot di alcune feature dell'impianto a nostra disposizione relative all'Inverter 2. In (a) viene mostrata la Total Energy , in (b) la CPU Temperature, in (c) la Voltage AC ed in (d) la Frequency.}
\end{figure}
...
\begin{table}[H]
	\begin{center}
		...
		\caption{This table displays some Solargis data
			%Global Horizontal Irradiation and Global Tilted Irradiation, 
			from \textquote{2022\_08\_01\_Rofilo\_NP00003174\_plantDevice.csv} file.}\label{tab:solargis}
	\end{center}
\end{table}
